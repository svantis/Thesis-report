...
%Om vi behöver en tie in: Instead of analysing the words themselves, they are converted into numerical representations that are easier for the computer to handle. 
...
%Vårt main mål var att förbättra performance med LSTM, snabbare tid blev en biprodukt. LSTM gjorde EmoryNLP snabbare ty default parametrar. LSTM+hyperparametrar gjorde MELD och IEMOCAP snabbare. Diskutera vidare. 
